    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          ...
          <li><router-link :to="{name: 'inbox-pms'}">Private Messages</router-link></li>
          <li class="dropdown">
...
import PrivateMessageNotificationDropdown from './private-messages/PrivateMessageNotificationDropdown'
export default {
  components: {
